<template>
  <header
    class="sticky top-0 z-50 flex h-[5rem] items-center justify-between bg-white px-[1vw] md:hidden"
  >
  <router-link to="/" class="cursor-pointer -ml-7">
    <LabelLogo
    class-name="transform scale-75"
      text-color="#1D2939"
      inner-color="#1D2939"
      outer-color="#FFFFFF"
    />
  ...
  <div class="flex items-center gap-2 sm:gap-4">
    ...
    <ButtonComponent is-icon @update:model-value="displayMenu = true">
...
import { displayMenu, displayUserDropdownMenu } from "@/store/resuableState.ts";
